...
(fact
  (create-docker-droplet "token" "my/docker/image" 9999) => nil
  (provided (do/create-droplet "token" nil {:name "coreos-ropensci":region "ams3" :size "512mb" :image 6373176 :ssh_keys [9999] :user_data expected-user-data}) => nil)
  )
